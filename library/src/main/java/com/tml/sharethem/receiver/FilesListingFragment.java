...
/*
        ...
        request.setDescription("FAST SHARE");
    ...
    private class SenderFilesListingAdapter extends RecyclerViewArrayAdapter<String, SenderFilesListItemHolder> {
        ...
        public void onBindViewHolder(SenderFilesListItemHolder holder, int position) {
            ...
            Log.d("listSize","senderfileslist"+senderFile.length());
            ...
            if (fileName.endsWith(".jpg") || fileName.endsWith("png") || fileName.endsWith("jpeg")) {
                ...
                holder.receiveImg.setImageResource(R.mipmap.receive_image_icon);

            } else if (fileName.endsWith(".3gp") || fileName.endsWith(".mp4") || fileName.endsWith(".mov") || fileName.endsWith(".flv")) {

                holder.receiveImg.setImageResource(R.mipmap.video_receive_icon);
            } else {
                // This is not an image file.
                Log.d("this is Video", "Not image");
                holder.receiveImg.setImageResource(R.mipmap.ic_type_file);
    ...
    static class SenderFilesListItemHolder extends RecyclerView.ViewHolder {
        ...
        SenderFilesListItemHolder(View itemView) {
            ...
            receiveImg=itemView.findViewById(R.id.receive_img_icon);
        }
    }
