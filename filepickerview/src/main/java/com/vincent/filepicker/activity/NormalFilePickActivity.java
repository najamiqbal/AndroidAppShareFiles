...
public class NormalFilePickActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        LDocTopAd=findViewById(R.id.LDoc_topAd);
        LDocBottomAd=findViewById(R.id.LDoc_bottomAd);
        LDocTopAd.loadAd(adRequest);
        LDocBottomAd.loadAd(adRequest);
