...
public class ImagePickActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        LImgTopAd=findViewById(R.id.LImg_topAd);
        LImgBottomAd=findViewById(R.id.LImg_bottomAd);
        LImgTopAd.loadAd(adRequest);
        LImgBottomAd.loadAd(adRequest);
