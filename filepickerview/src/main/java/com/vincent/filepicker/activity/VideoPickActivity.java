...
public class VideoPickActivity extends BaseActivity {
    ...
    AdView LVedioTopAd,LVedioBottomAd;
    ...
    private void initView() {
        ...
        LVedioTopAd=findViewById(R.id.LV_topAd);
        LVedioBottomAd=findViewById(R.id.LV_bottomAd);
        LVedioTopAd.loadAd(adRequest);
        LVedioBottomAd.loadAd(adRequest);
