...
public class AudioPickActivity extends BaseActivity {
    ...
    AdView LaudioTopAd,LaudioBottomAd;
    ...
    private void initView() {
        ...
        LaudioTopAd=findViewById(R.id.LAudio_topAd);
        LaudioBottomAd=findViewById(R.id.LAudio_bottomAd);
        LaudioTopAd.loadAd(adRequest);
        LaudioBottomAd.loadAd(adRequest);
